QuestieLocale.locale['zhCN'] = {
    ...
    ['ICON_TYPE_HEADER'] = "图标设置",
    ['ENABLE_MAP_ICONS'] = "启用大地图任务标记",
    ['ENABLE_MAP_ICONS_DESC'] = "在大地图上显示或隐藏任务提示",
    ['ENABLE_MINIMAP_ICONS'] = "启用小地图任务标记",
    ['ENABLE_MINIMAP_ICONS_DESC'] = "在小地图上显示或隐藏任务提示",
    ...
    ['MAP_GLOBAL_SCALE'] = "小地图标记图标的比例调整",
    ['MAP_GLOBAL_SCALE_DESC'] = "小地图上标记图标的大小。  (默认: %s )",
    ['MINIMAP_FADE'] = "小地图标记淡出",
    ['MINIMAP_FADING'] = "根据目标距离淡出标记",
    ['MINIMAP_FADING_DESC'] = "根据任务目标距离的远近调整图标的透明度 (默认: %s )",
    ['MINIMAP_FADE_PLAYER'] = "根据玩家距离淡出标记",
    ['MINIMAP_FADE_PLAYER_DESC'] = "当玩家处于目标附近时淡出小地图上的任务标记。",
    ['MINIMAP_FADE_PLAYER_DIST'] = "淡出的距离",
    ['MINIMAP_FADE_PLAYER_DIST_DESC'] = "任务标记距离玩家多远时开始淡出。 (默认: %s )",
    ['MINIMAP_FADE_PLAYER_LEVEL'] = "淡出的透明度",
    ['MINIMAP_FADE_PLAYER_LEVEL_DESC'] = "玩家附近的任务标记淡出的透明度数值。 (默认: %s )",
    ['MINMAP_COORDS'] = "小地图座标",
    ...
    ['LOOT_ICON_SCALE'] = "3. 战利品图标大小",
    ['LOOT_ICON_SCALE_DESC'] = "调整战利品图标的缩放比例（默认%s）",
    ...
    ['ICON_TOGGLE_QUESTIE'] = "显示/隐藏Questie",
    ['ICON_CTRLRIGHT_CLICK'] = "Ctrl + 右键",
    ['ICON_HIDE'] = "隐藏小地图图标",
    ['ICON_RIGHT_CLICK'] = "右键",
    ['ICON_JOURNEY'] = "查看我的任务历程",
    ...
    ['JOUNREY_TAB'] = "我的任务历程",
    ['JOURNEY_ZONE_TAB'] = "按地区查询",
    ['JOURNEY_SEARCH_TAB'] = "进阶查询",
    ...
    ['JOURNEY_PARTY_TITLE'] = "公会成员加入了",
    ['JOURNEY_BEGIN'] = "是时候踏上旅程了！",
    ['JOURNEY_SEARCH_HEAD'] = "在搜索框中输入",
    ['JOURNEY_SEARCH_CRITERIA'] = "选择搜索条件",
