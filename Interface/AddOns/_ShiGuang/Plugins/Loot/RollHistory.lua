--## Author: Vladinator ## Version: 8.0.0.180617
local _G = _G
...
-- framexml references
local GameTooltip = GameTooltip -- GameTooltip.lua
local RAID_CLASS_COLORS = RAID_CLASS_COLORS -- Constants.lua
local LootHistoryFrameUtil_ShouldDisplayPlayer = LootHistoryFrameUtil_ShouldDisplayPlayer -- LootHistory.lua:443
local STANDARD_TEXT_FONT = STANDARD_TEXT_FONT -- Fonts.xml:8
...
f:RegisterEvent("LOOT_HISTORY_FULL_UPDATE")
f:RegisterEvent("LOOT_HISTORY_ROLL_CHANGED")
f:RegisterEvent("LOOT_HISTORY_ROLL_COMPLETE")
