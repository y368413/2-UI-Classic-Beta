...
function S:CharacterStatsClassic()
	...
	if ShiGuangDB.CharacterStatsexpandStat == nil then
		ShiGuangDB.CharacterStatsexpandStat = false
	end
	...
	bu:SetScript("OnClick", function(self)
		...
		ShiGuangDB.CharacterStatsexpandStat = not ShiGuangDB.CharacterStatsexpandStat
		ToggleStatPanel(self.collapse)
	end)

	ToggleStatPanel(not ShiGuangDB.CharacterStatsexpandStat)
end
...
function S:RecountSkin()
	if not MaoRUIPerDB["Skins"]["Recount"] then return end
