...
local optionList = {		-- type, key, value, name, horizon, horizon2, doubleline
	[1] = {
		...
		{3, "UFs", "PlayerFrameScale", U["PlayerFrame Scale"], true, false, {0.6, 1.2, 1}},
	...
	[2] = {
		...
		{3, "Nameplate", "PlateWidth", U["NP Width"].."*", true, false, {50, 250, 0}, refreshNameplates},
		{3, "Nameplate", "PlateHeight", U["NP Height"].."*", true, true, {5, 30, 0}, refreshNameplates},
		{3, "Nameplate", "NameTextSize", U["NameTextSize"].."*", false, false, {10, 30, 0}, refreshNameplates},
		{3, "Nameplate", "HealthTextSize", U["HealthTextSize"].."*", true, false, {10, 30, 0}, refreshNameplates},
		{2, "Nameplate", "UnitList", U["UnitColor List"].."*", true, true, nil, updateCustomUnitList, U["CustomUnitTips"]},
		{3, "Nameplate", "maxAuras", U["Max Auras"], false, false, {0, 10, 0}},
