...
U["ReminderTip"] = "|n根據自身職業，缺少特定Buff時進行提示。|n支持耐力/智力/戰鬥怒吼/野性印記/心靈之火/荊棘術。"
U["Enable UFs"] = "啟用頭像框架"
...
U["Type Intro"] = "|nAuraID: 監控Buff/Debuff的狀態；|n|nSpellID: 監控技能法術的冷卻時間；|n|nSlotID: 監控裝備欄位的冷卻時間；|n|nTotemID: 監控對應圖騰的冷卻時間。"
U["ID Intro"] = "|n法術的編號，必須為數字。|n|n你可以在法術的滑鼠提示框中看到ID。|n|n不支持直接輸入法術名稱。"
U["Unit Intro"] = "|n監控法術所來自的單位。|n|nplayer: 玩家單位的法術；|n|ntarget: 目標單位的法術；|n|npet: 寵物單位的法術。"
...
U["Priority"] = "優先級"
U["Priority Intro"] = "|n法術監控圖示的顯示優先級。|n|n同一時間存在多個法術時，僅顯示優先級最高的那一個。|n|n最高為6，同時高亮該優先級的光環。|n|n留空則預設為2。"
U["Existing ClickSet"] = "該按鍵組合已綁定技能。"
U["Invalid Input"] = "你所輸入的按鍵行為無效。"
U["Action*"] = "行為*"
U["Action Intro"] = "|n為團隊框架設定按鍵行為。|n|n輸入target，設定目標；|n|n輸入follow，設定跟隨；|n|n輸入數字，設定施法的法術ID。此操作會固定使用最高等級的法術；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用符號~表示換行。|n若要設定不同等級的法術，你只能輸入巨集（指向）。"
U["Key*"] = "按鍵*"
...
U["PlayerPlate CPHeight"] = "連擊點高度"
U["PlayerPlate HPHeight"] = "血量高度"
U["PlayerPlate MPHeight"] = "能量高度"
U["AuraWatch IconScale"] = "技能監控圖示縮放"
...
U["Nameplate ClassPower"] = "在目標名條顯示連擊點"
...
U["ItemLevel"] = "物品等級"
U["QuickKeybindMode"] = "快速按鍵設定模式"
U["QuickKeybindDescription"] = "你已進入快速按鍵設定模式。將滑鼠游標移動到快捷鍵圖示上，然後按下鍵盤按鍵，即可將它們綁定。"
U["KeyIndex"] = "序號"
U["KeyBinding"] = "按鍵"
U["KeyBoundTo"] = "綁定按鍵"
