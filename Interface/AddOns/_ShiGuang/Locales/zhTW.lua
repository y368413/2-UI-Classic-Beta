...
U["Enable Reminder"] = "技能缺失提示（耐力/智力）"
...
U["Unit Intro"] = "|n監視法術所來自的單位。|n|nplayer: 玩家單位的法術；|n|ntarget: 目標單位的法術；|n|npet: 寵物單位的法術。"
...
U["Action*"] = "行為*"
U["Action Intro"] = "|n為團隊框架設置按鍵行為。|n|n輸入target，設置目標；|n|n輸入follow，設置跟隨；|n|n輸入數字，設置施法的法術ID；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用\\n來進行換行。"
U["Key*"] = "按鍵*"
U["Key Intro"] = "|n為該法術綁定一個滑鼠按鍵。|n|n為防止衝突，不建議設置單獨的左鍵或者中鍵。"
U["Modified Key"] = "功能键"
U["ModKey Intro"] = "|n為該法術設置組合鍵。"
...
U["Instance Type"] = "|n選擇你要添加的ID所屬副本類型。|n|n團隊分組的僅在團隊副本中生效，其他分組則在團隊副本外生效。"
...
U["DeleteMode Enabled"] = "|n按住CTRL+ALT鍵，直接點擊摧毀背包中低於藍色精良品質的物品。"
...
U["RaidHPLost"] = "顯示損失血量"
U["AlertFrames"] = "物品Roll點框架"
U["UIWidgetFrame"] = "小地圖下方特殊框架|n|n如PVP占點"
...
U["Show ItemLevel"] = "顯示裝備的物品等級"
U["Show ItemQuality"] = "角色面板裝備品質信息"
U["MapFader"] = "移動時淡化地圖"
U["EnhancedQuestLog"] = "增强任務列表和追蹤"
U["EnhancedQuestLogTips"] = "|n拓寬默認的任務列表，同時美化默認的任務追蹤。|n|n無需再安裝ClassicQuestLog等插件。"
U["TargetEnhancedMenu"] = "目標右鍵菜單增强"
...
U["Pet&*Target"] = "寵物和目標的目標框架"
U["LockChatWidth"] = "鎖定的寬度"
U["LockChatHeight"] = "鎖定的高度"
U["QuestIndicatorAddOns"] = "|n支援插件:|n- ClassicCodex|n- Questie"
U["MenuEnhancedTips"] = "|n給目標和隊友的右鍵菜單添加公會邀請和添加好友的選項。"
U["Nameplate ClassPowerOnly"] = "隱藏血條及能量條"
U["AuraWatch WatchSpellRank"] = "監控法術的不同等級"
U["ExtendedQuestLogAddons"] = "|n支援插件:|n- ClassicQuestLog|n- QuestGuru|n- QuestLogEx"
...
U["HideAllID"] = "關閉所有法術及物品信息"
U["EnergyTicker"] = "回能/回藍監控"
U["ClassColorChat"] = "强制顯示職業顔色"
U["Recount Skin"] = "啓用Recount皮膚"
U["Reset Details check"] = "你想要重置Details的皮膚美化嗎？"
U["SpecialBagsColor"] = "添加特殊背包的背景色"
U["SpecialBagsColorTip"] = "|n為獵人的箭袋、術士的靈魂袋以及附魔、草藥袋添加背景顔色。"
U["CustomUnitTips"] = "|n直接輸入目標的名字。"
U["TradeTabs"] = "專業面板快捷標簽"
U["TradeTabsTips"] = "|n在專業面板顯示快捷切換的按鈕。|n|n在懷舊服中，附魔面板不屬於專業面板的一部分。"
