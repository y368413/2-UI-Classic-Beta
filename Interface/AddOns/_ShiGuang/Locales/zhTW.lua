...
U["Skip"] = "跳過"
U["Sort"] = "整理"
U["Chat Copy"] = "|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:230:307|t 複製|n|TInterface\\TUTORIALFRAME\\UI-TUTORIAL-FRAME:13:11:0:-1:512:512:12:66:333:411|t 選單"
U["Collect All"] = "打開所有"
U["Collect Gold"] = "收取金幣"
...
U["Default Settings Check"] = "已經加載預設設定。"
U["Chat Settings Check"] = "已經加載聊天視窗設定。"
...
U["Action*"] = "行為*"
U["Action Intro"] = "|n為團隊框架設定按鍵行為。|n|n輸入target，設定目標；|n|n輸入follow，設定跟隨；|n|n輸入數字，設定施法的法術ID。此操作會固定使用最高等級的法術；|n|n你也可以直接輸入巨集。|n對於存在多行内容的巨集，用符號~表示換行。|n若要設定不同等級的法術，你只能綁定巨集（指向）。|n|n你可以使用巨集來為不同專精分別設定:|n/cast [@mouseover,spec1]XXX;[@mouseover,spec2]XXX"
U["Key*"] = "按鍵*"
U["Key Intro"] = "|n為該法術綁定一個滑鼠按鍵。|n|n為防止衝突，不建議設定單獨的左鍵或者中鍵。"
U["Modified Key"] = "功能键"
U["ModKey Intro"] = "|n為該法術設定組合鍵。"
...
U["Tooltip Scale"] = "滑鼠提示框縮放"
U["Differ WhisperColor"] = "為密語雙方使用不同顔色"
U["Map Reveal"] = "去除地圖迷霧"
...
U["Show ItemQuality"] = "角色面板裝備品質資訊"
U["MapFader"] = "移動時淡化地圖"
U["EnhancedQuestLog"] = "增强任務列表和追蹤"
U["EnhancedQuestLogTips"] = "|n拓寬預設的任務列表，同時美化預設的任務追蹤。|n|n無需再安裝ClassicQuestLog等插件。"
U["TargetEnhancedMenu"] = "目標右鍵選單增强"
...
U["MenuEnhancedTips"] = "|n給目標和隊友的右鍵選單添加公會邀請和添加好友的選項。"
...
U["DisableInfobars"] = "關閉所有資訊條模塊"
U["FreeSlots"] = "空閑背包欄位"
U["Bags GatherEmpty"] = "合併背包空閑欄位"
...
U["HideAllID"] = "關閉所有法術及物品資訊"
U["EnergyTicker"] = "回能/回藍監控"
U["ClassColorChat"] = "强制顯示職業顔色"
U["Recount Skin"] = "啟用Recount皮膚"
