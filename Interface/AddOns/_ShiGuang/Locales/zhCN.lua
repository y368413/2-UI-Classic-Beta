...
U["ReminderTip"] = "|n根据自身职业，缺少特定Buff时进行提示。|n支持耐力/智力/战斗怒吼/野性印记/心灵之火/荆棘术。"
U["Enable UFs"] = "启用头像框体"
...
U["Unit Intro"] = "|n监控法术所来自的单位。|n|nplayer: 玩家单位的法术；|n|ntarget: 目标单位的法术；|n|npet: 宠物单位的法术。"
...
U["Action*"] = "行为*"
U["Action Intro"] = "|n为团队框体设置按键行为。|n|n输入target，设置目标；|n|n输入follow，设置跟随；|n|n输入数字，设置施法的法术ID。此操作会固定使用最高等级的法术；|n|n你也可以直接输入宏。|n对于存在多行内容的宏命令，用符号~表示换行。|n若要设置不同等级的法术，你只能输入宏（指向）。"
U["Key*"] = "按键*"
U["Key Intro"] = "|n为该法术绑定一个鼠标按键。|n|n为防止冲突，不建议设置单独的左键或者中键。"
U["Modified Key"] = "功能键"
U["ModKey Intro"] = "|n为该法术设置组合键。"
...
U["Instance Type"] = "|n选择你要添加的ID所属副本类型。|n|n团队分组的仅在团队副本内生效，其他分组的则在团队副本之外生效。"
...
U["DeleteMode Enabled"] = "|n按住CTRL+ALT键，可直接点击摧毁背包中低于蓝色精良品质的物品。"
...
U["AlertFrames"] = "物品Roll点框体"
U["UIWidgetFrame"] = "小地图下方特殊框体|n|n如PVP占点"
U["Horizon PartyFrame"] = "小队横向排列"
U["Nameplate ClassPower"] = "在目标姓名板上显示连击点"
...
U["Show ItemLevel"] = "显示装备的物品等级"
U["Show ItemQuality"] = "角色面板装备品质信息"
U["MapFader"] = "移动时淡化地图"
U["EnhancedQuestLog"] = "增强任务列表和追踪"
U["EnhancedQuestLogTips"] = "|n扩展默认的任务列表，同时美化默认的任务追踪。|n|n无需再安装ClassicQuestLog等插件。"
U["TargetEnhancedMenu"] = "目标右键菜单增强"
...
U["Pet&*Target"] = "宠物和目标的目标框体"
U["LockChatWidth"] = "锁定的宽度"
U["LockChatHeight"] = "锁定的高度"
U["QuestIndicatorAddOns"] = "|n支持插件:|n- ClassicCodex|n- Questie"
U["MenuEnhancedTips"] = "|n给目标及队友的右键菜单添加公会邀请和添加好友选项。"
U["Nameplate ClassPowerOnly"] = "隐藏血条及能量条"
U["AuraWatch WatchSpellRank"] = "监控法术的不同等级"
...
U["EnergyTicker"] = "回能/回蓝监控"
U["ClassColorChat"] = "强制显示职业颜色"
U["Recount Skin"] = "启用Recount皮肤"
U["Reset Details check"] = "你想要重置Details的皮肤美化吗？"
U["SpecialBagsColor"] = "添加特殊背包的背景色"
U["SpecialBagsColorTip"] = "|n为猎人的箭袋、术士的灵魂袋以及附魔、草药袋添加背景颜色。"
U["CustomUnitTips"] = "|n直接输入目标的名字。"
U["TradeTabs"] = "专业面板快捷标签"
U["TradeTabsTips"] = "|n在专业面板侧边显示快捷切换按钮。|n|n在怀旧服中，附魔面板不属于专业面板的一部分。"
...
U["EnhancedTradeSkills"] = "拓展专业及附魔界面"
U["SmoothAmount"] = "平滑变化频率"
U["SmoothAmountTip"] = "|n调节头像和姓名板血量等平滑变化的频率。|n平滑度随着频率提高而降低。"
U["ShowAllTip"] = "|n默认不勾选，只显示玩家自己施放的Buff。|n|n勾选后，则将显示所有人释放的Buff。"
U["TototUF"] = "目标的目标的目标"
U["UFs ToToT"] = "启用目标的目标的目标"
...
U["ItemLevel"] = "物品等级"
U["QuickKeybindMode"] = "快速快捷键模式"
U["QuickKeybindDescription"] = "你处于快速快捷键模式。将鼠标移到一个按钮上并按下你想要的按键，即可设置那个按钮的快捷键。"
U["KeyIndex"] = "序号"
U["KeyBinding"] = "按键"
U["KeyBoundTo"] = "绑定按键"
